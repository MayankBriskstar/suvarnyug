...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($('.hot-deals-active').length) {
            var totalSlides = $('.hot-deals-active .destination-item').length;
            ...
            $('.hot-deals-active').slick({
                ...
                autoplay: true,
                autoplaySpeed: 5000,
                slidesToShow: totalSlides < 5 ? totalSlides : 5, // Show fewer slides if data is less
                slidesToScroll: 1,
                responsive: [
                    {
                        breakpoint: 991,
                        settings: {
                            slidesToShow: totalSlides < 2 ? totalSlides : 2, // Adjust for smaller screen
                        }
                    },
                    {
                        breakpoint: 767,
